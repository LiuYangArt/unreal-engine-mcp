...
def register_blueprint_tools(mcp: FastMCP):
    ...
    def create_blueprint(
        ...
        """Create a new Blueprint class.\n\n        Args:\n            name: Blueprint asset name to create under /Game/Blueprints\n            parent_class: Parent class identifier. Supports short class names like ACodexProbeActor, full script paths like /Script/AS_Shooter.ACodexProbeActor, and Blueprint asset paths when creating a Blueprint from another Blueprint class.\n        """
    ...
    def set_component_property(
        ...
        """Set a property on a component in a Blueprint.\n\n        property_value may be a primitive, an asset path/object path string, a Blueprint class path string, or a vector-like list such as [X, Y, Z].\n        """
        from unreal_mcp_server import get_unreal_connection
    ...
    def set_blueprint_property(
        ...
        Args:
            ...
            property_value: Value to set the property to. Supports primitives, asset path strings, class path strings, and vector-like lists such as [X, Y, Z] or [Pitch, Yaw, Roll]
